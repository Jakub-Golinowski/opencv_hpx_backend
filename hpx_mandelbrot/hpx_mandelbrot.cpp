...
int hpx_main(boost::program_options::variables_map& vm)
{
    ...
    hpx::future<void> f_save_image = hpx::async(opencv_executor,
            &save_image, mandelbrotImg, "mandelbrot.bmp");
    hpx::async(opencv_executor,
               &show_image, mandelbrotImg, "Mandelbrot");
...
int main(int argc, char* argv[]) {
    ...
    desc_cmdline.add_options()
            ("opencv_tp_num_threads,m",
             ...
             "Number of threads to assign to opencv pool")
            ("mb-size", po::value<int>()->default_value(500),
